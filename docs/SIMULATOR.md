...
[README](../README.md) · [Запуск, конфигурация и API](DEVELOPMENT.md)

## Обучение «как это работает»

![Онбординг: от плана к расчёту и объяснению](images/onboarding.png)
...
![Совет: круглый стол и проверенные выступления](images/council.png)
...
Разметку требований положения и подтверждающих материалов ведём в [плане версии 0.1](compliance/PLAN.md) и [первичной карте требований](compliance/RULES_MAP.md). Они **в работе**: детализация и итоговое отражение в README продолжаются, полное соответствие пока не заявлено.
...
Пути backend-тестов относительно `apps/api/tests`, frontend-тестов — `apps/web/tests`. Точные команды запуска приведены в [руководстве разработчика](DEVELOPMENT.md).
