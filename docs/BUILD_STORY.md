...
Реализованы разбор плана и совет; самообучение и NPC-соперники остались замыслом. Отдельный runtime Builder 2 находится в [draft PR #22](https://github.com/BAITC-Hacks/hack-b0e0ddb6-t-sting/pull/22), включение в основной сценарий не подтверждено. Публичная страница, health и сценарий astana-v1 доступны; SHA деплоя не установлен. Старые слова об отсутствии деплоя описывают ранний этап.
